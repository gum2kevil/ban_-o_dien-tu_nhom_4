			...
			<div class="top-nav">
				<ul>
					...
					<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Cửa hàng <span class="caret"></span></a>
						<ul class="dropdown-menu" style="background: #81DAF5" >
						<li><a style="padding-right: 100px" href="/laptopshop/store?brand=LAPTOP">LAPTOP</a></li>
						<li><a style="padding-right: 100px" href="/laptopshop/store?brand=TIVI">TIVI</a></li>
						<li><a style="padding-right: 100px" href="/laptopshop/store?brand=TỦ%20LẠNH">TỦ LẠNH</a></li>
						<li><a style="padding-right: 100px" href="/laptopshop/store?brand=MÁY%20GIẶT">MÁY GIẶT</a></li>
						<li><a style="padding-right: 100px" href="/laptopshop/store?brand=%20BÌNH%20NƯỚC%20NÓNG">BÌNH NƯỚC NÓNG</a></li>
						<li><a style="padding-right: 100px" href="/laptopshop/store?brand=ĐIỀU%20HÒA%20KHÔNG%20KHÍ">ĐIỀU HÒA KHÔNG KHÍ</a></li>
						<li><a style="padding-right: 100px" href="/laptopshop/store?brand=ĐIỆN%20GIA%20DỤNG">ĐIỆN GIA DỤNG</a></li>						
						<li><a style="padding-right: 100px" href="/laptopshop/store?brand=PHỤ%20KIỆN%20CÁC%20LOẠI">PHỤ KIỆN CÁC LOẠI</a></li>
						</ul>
